...
**Publications**
- _**Kai Zhang**_, Qi Liu, Hao Qian, Biao Xiang, Qing Cui, Jun Zhou, Enhong Chen. [_EATN: An Efﬁcient Adaptive Transfer Network for Aspect-level Sentiment Analysis_][3-paper-wsdm], IEEE Transactions on Knowledge and Data Engineering (_**IEEE TKDE'2021**_). (CCF A类期刊)
